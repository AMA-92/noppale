-- =====================================================
-- FIX COMPLET: Synchronisation CA et Dettes
-- =====================================================
...
-- 4. Recréer la fonction CORRIGÉE avec remaining_amount et support DELETE
...
BEGIN
  ...
  -- Mettre à jour la vente avec tous les champs
  UPDATE public.sales 
  SET 
    paid_amount = v_paid,
...
-- 7. Recalculer paid_amount pour toutes les ventes
UPDATE public.sales
...
-- 8. Recalculer remaining_amount pour toutes les ventes
UPDATE public.sales
SET remaining_amount = GREATEST(0, total - COALESCE(paid_amount, 0));

-- 9. Mettre à jour payment_status pour les ventes à crédit
UPDATE public.sales
...
-- 10. Pour les ventes non-credit, s'assurer qu'elles sont marquées comme payées
UPDATE public.sales
SET 
  payment_status = 'paid',
  paid_amount = total,
...
-- 11. Vérification: Résumé des ventes
SELECT 
...
-- 12. Vérification: Ventes à crédit avec dette
SELECT 
...
SELECT 'Fix complet appliqué avec succès!' as status;
