-- ÉTAPE 2: Créer la fonction de synchronisation pour "profiles" (VERSION CORRIGÉE)
...
-- Maintenant supprimer la fonction en toute sécurité
...
-- Conclusion
SELECT '=== ÉTAPE 2 TERMINÉE (VERSION CORRIGÉE) ===' as step;
